...
print("Please excuse my son {} from {} today. He is suffering from a badcase of {} which has caused him a lot of {} pain. He wont be able to attend class for {} days".format(name, subject, illness, body_part, number))